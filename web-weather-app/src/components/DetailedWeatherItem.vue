<template>
    <div class="info-wrapper">
        <div class="max-temp">Max temperature is {{Math.round(weather.main.temp_max)}}°C</div>
        <div class="min-temp">Min temperature is {{Math.round(weather.main.temp_min)}}°C</div>
